...
#define UCP_MEM_IS_GAUDI_DEVICE(_mem_type)  ((_mem_type) == UCS_MEMORY_TYPE_GAUDI_DEVICE)
#define UCP_MEM_IS_GAUDI_HOST(_mem_type)    ((_mem_type) == UCS_MEMORY_TYPE_GAUDI_HOST)
#define UCP_MEM_IS_GAUDI_MANAGED(_mem_type) ((_mem_type) == UCS_MEMORY_TYPE_GAUDI_MANAGED)
